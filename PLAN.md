...
- **2026-05-07.** Default judges for Phase 1: Anthropic Haiku + Gemini 2.0 Flash. Reasoning: disjoint families, both cheap, both reliably produce structured JSON. OpenAI judge held back since student/tutor are generated by Gemini-OpenAI-API loop and we want at least one judge fully outside the generation pipeline.
